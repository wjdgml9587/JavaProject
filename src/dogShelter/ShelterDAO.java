...
public class ShelterDAO {
	...
	// 2. 회원가입
	public void memberJoin(String sId, String sPw, String sName, String sAddr, String sEmail, String sPhone) {
		String sql = "INSERT INTO SHELTER(SID, SPW, SNAME, SADDR, SPHONE, SEMAIL)" + " VALUES(?, ?, ?, ?, ?, ?)";
	...
	public void don(String donId) {
		...
		try {
			...
			if (rs.next()) {
				...
				System.out.println("후원금이 존재하지 않습니다!");
			}
